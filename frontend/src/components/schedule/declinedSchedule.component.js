...
export class DeclinedScheduleRequestList extends Component {
    ...
    searchScheduleList() {
        return this.state.schedule.map((currentschedule) => {
            if (
                ...
                class="text-base inline-block whitespace-nowrap rounded-full bg-red-400 p-1 hover:bg-red-500 hover:drop-shadow-md hover:text-white  px-2 pt-[0.35em] pb-[0.25em] text-center align-baseline text-[0.75em] font-bold leading-none text-primary-700">{currentschedule.status}</span></td>
                        <td className='px-6 py-4'>
                            {
                                <div class="">
